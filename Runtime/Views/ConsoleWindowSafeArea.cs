...
{
    public class ConsoleWindowSafeArea : MonoBehaviour
    {
        #region Simulations
        /// <summary>
        ...
        /// </summary>
        public static SimulatorDevice Sim = SimulatorDevice.None;
        ...
        private Rect GetSafeArea()
        {
            ...
            if (Application.isEditor && Sim != SimulatorDevice.None)
            {
                ...
                switch (Sim)
                {
                    case SimulatorDevice.iPhoneX:
                        if (Screen.height > Screen.width)  // Portrait
                            ...
                            nsa = NSA_iPhoneX[1];
                        break;
                    case SimulatorDevice.iPhoneXsMax:
                        if (Screen.height > Screen.width)  // Portrait
                            nsa = NSA_iPhoneXsMax[0];
                        else  // Landscape
                            nsa = NSA_iPhoneXsMax[1];
                        break;
                    case SimulatorDevice.Pixel3XL_LSL:
                        if (Screen.height > Screen.width)  // Portrait
                            nsa = NSA_Pixel3XL_LSL[0];
                        else  // Landscape
                            nsa = NSA_Pixel3XL_LSL[1];
                        break;
                    case SimulatorDevice.Pixel3XL_LSR:
                        if (Screen.height > Screen.width)  // Portrait
